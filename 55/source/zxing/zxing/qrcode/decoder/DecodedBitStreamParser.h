...
#include <sstream>
#include <map>
#include <55/source/zxing/zxing/qrcode/decoder/Mode.h>
#include <55/source/zxing/zxing/common/BitSource.h>
...
#include <55/source/zxing/zxing/common/CharacterSetECI.h>
